...
import { idlFactory } from './health_connect_backend.did.js';
export { idlFactory } from './health_connect_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HEALTH_CONNECT_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./health_connect_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the health_connect_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./health_connect_backend.did.js")._SERVICE>}
 */
export const health_connect_backend = createActor(canisterId);
